 ...
 *
 * * Ejercicio:
 * En este ejercicio se modela el estado de un editor de código
 * (CodeEditorState) como un objeto inmutable (propiedades readonly), donde
 * cada cambio genera un nuevo estado mediante copyWith, y un historial
 * (CodeEditorHistory) guarda esos estados para poder navegar entre ellos con
 * undo y redo.
 *
 * Se espera entender cómo trabajar con objetos inmutables y copias en lugar
 * de mutar el estado directamente, lo cual facilita implementar
 * funcionalidades como deshacer/rehacer al conservar cada versión anterior
 * del objeto.
 */
